(function () {
  ...
  var introduction = function () {
    return [
      ...
      p("A website written in HCJ contains no CSS whatsoever.  The CSS language provides an enormous number of styles, some combinations of which interact in very bizarre and highly surprising ways.  Most website editors have rigid templates that you must fit your site into, and are very finnicky with regard to the spacing, margins, and padding around page elements because of this.  HCJ, on the other hand, provides a single, simple yet powerful interface by which elements are arranged on the web page.  On top of this, its standard library implements its own enormous number of elements and layouts.  Just by implementing the same interface, you can write your own, all of which work together seamlessly.  Using HCJ components and layouts, you can effortlessly format your content on any screen size just how you want."),
      p("The framework's building blocks are referred to as \"components\".  Any component can be rendered as a web page, making unit testing very simple.  These respond to the size and shape of their environment, so rearranging your page is as easy as copy-and-paste, and mobile-responsive design automatic."),
