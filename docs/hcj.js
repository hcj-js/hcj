...
(function () {
  ...
  var runDomStyles = function () {
    for (var i = 0; i < updateDomFuncs.length; i++) {
  ...
  var outerWidth = function (el) {
    ...
    var width = el.offsetWidth + parseFloat(style.marginLeft) + parseFloat(style.marginRight);
  }
  var outerHeight = function (el) {
    var style = window.getComputedStyle(el);
    var width = el.offsetHeight + parseFloat(style.marginTop) + parseFloat(style.marginBottom);
  }
